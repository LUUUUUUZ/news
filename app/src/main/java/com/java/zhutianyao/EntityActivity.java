...
public class EntityActivity extends BasicActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        searchbox.setHint("Search for Entities");
            ...
            public boolean onEditorAction(TextView textView, int i, KeyEvent keyEvent) {
                if(i== EditorInfo.IME_ACTION_SEARCH){
                    if(textView.getText().length()==0){
                        Toast.makeText(EntityActivity.this,"The input cannot be empty.",Toast.LENGTH_SHORT).show();
                    }else{
                        goSearch();
                    }
                    return true;
        ...
        switchFragment(new EntityhomeFragment());
    ...
    void goSearch(){
        ...
        //转到搜索结果页面,这里做完全匹配好了，只返回一个实体
        switchFragment(new EntityResultFragment(text));
    }
}
