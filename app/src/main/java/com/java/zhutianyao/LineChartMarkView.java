    ...
    public void refreshContent(Entry e, Highlight highlight) {
        ...
        if (chart instanceof LineChart) {
            ...
            for (int i = 0; i < dataSetList.size(); i++) {
                ...
                if (i == 0) {
                    tvValue0.setText(dataSet.getLabel() + "：" +(int)y+" people");
                }
                if (i == 1) {
                    tvValue1.setText(dataSet.getLabel() + "：" + (int)y+" people");
                }
            }
            tvname.setText(xAxisValueFormatter.getFormattedValue(e.getX(), null));
        }
